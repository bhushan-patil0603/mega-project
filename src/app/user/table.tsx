...
const DataTable = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 py-10 px-4">
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        <div className="p-6">
          <h2 className="text-3xl font-semibold text-gray-800 mb-6 text-center">Customer Information</h2>
              ...
              <tbody>
                {Object.entries(data).map(([key, item], index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-3 text-gray-700">{item.start_date}</td>
